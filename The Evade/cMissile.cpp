...
/*
=================================================================
  Sets the velocity for the Missile
=================================================================
*/
void cMissile::setMissileVelocity(glm::vec2 MissileVel)
{
	MissileVelocity = MissileVel;
}
/*
=================================================================
  Gets the Missile velocity
=================================================================
*/
glm::vec2 cMissile::getMissileVelocity()
{
...
==========================================================================
*/
void cMissile::renderCollisionBox()
{
	glPushMatrix();
